...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.mouseCps=function()
		{
			...
			add=add*num;
			if (Game.Has('Plastic mouse')) add+=Game.cookiesPs*0.10;
			if (Game.Has('Iron mouse')) add+=Game.cookiesPs*0.20;
			if (Game.Has('Titanium mouse')) add+=Game.cookiesPs*0.20
			if (Game.Has('Adamantium mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Unobtainium mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Eludium mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Wishalloy mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Fantasteel mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Nevercrack mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Armythril mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Technobsidian mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Plasmarble mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Miraculite mouse')) add+=Game.cookiesPs*0.05;
			if (Game.Has('Aetherice mouse')) add+=Game.cookiesPs*0.05;
